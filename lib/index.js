...
<body>
    ...
    <footer class="site-footer">
        <p>&copy; 2026 {{siteTitle}}. Built with lite-blog.</p>
    </footer>
</body>
</html>`,
...
/**
 * Highlight.js CSS (minimal dark theme)
 */
const hljsCSS = `/* Highlight.js dark theme */
.hljs {
  background: #2d2d2d;
  color: #f8f8f2;
}
...
This blog is built with [lite-blog](https://github.com/user/lite-blog) - a lightweight static site generator.
